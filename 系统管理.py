...
#点击组织设置
#点击机组设置是ul的第三个子元素，以此类推定位后面的采集器设置等
wd.find_element(By.CSS_SELECTOR,"ul[class$=child-list-move]>:nth-child(2)").click()


#点击机组设置
wd.find_element(By.XPATH,"/html/body/div[1]/div[2]/div[1]/div/ul[1]/li[2]/a").click()


#点击采集器绑定
wd.find_element(By.XPATH,"/html/body/div[1]/div[2]/div[1]/div/ul[1]/li[3]/a").click()


#点击采集器设置
wd.find_element(By.XPATH,"/html/body/div[1]/div[2]/div[1]/div/ul[1]/li[4]/a").click()


#点击测点设置
wd.find_element(By.XPATH,"/html/body/div[1]/div[2]/div[1]/div/ul[1]/li[6]/a").click()
...
#点击导入导出
wd.find_element(By.XPATH,"/html/body/div[1]/div[2]/div[1]/div/ul[1]/li[8]/a").click()
